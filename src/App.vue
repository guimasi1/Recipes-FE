    ...
    <header>
      <nav class="flex justify-between gap-1 md:gap-12 pt-1 mt-2 px-12">
        <div>
          <RouterLink
            to="/"
            class="font-bold text-lg hover:bg-lime-400 hover:text-black px-4 py-1 rounded-2xl"
          >
            Home</RouterLink
          >
        </div>
        ...
        <div v-if="loggedIn" class="flex gap-3">
          ...
          <div class="font-bold text-lg hover:bg-lime-400 hover:text-black px-4 py-1 rounded-2xl">
